...
{
    TEST_ASSERT_EQUAL_INT(1, hash_code(map->dimension, 11));
    TEST_ASSERT_EQUAL_INT(2, hash_code(map->dimension, 22));
    TEST_ASSERT_EQUAL_INT(3, hash_code(map->dimension, 33));
    TEST_ASSERT_EQUAL_INT(4, hash_code(map->dimension, 44));
    TEST_ASSERT_EQUAL_INT(0, hash_code(map->dimension, 55));
    TEST_ASSERT_EQUAL_INT(1, hash_code(map->dimension, 66));
    TEST_ASSERT_EQUAL_INT(2, hash_code(map->dimension, 77));
}
